#!/usr/bin/env python3
"""
Generate the ULTIMATE CPPCheck Dashboard with all features working

⚠️ DEPRECATION WARNING: This generator is deprecated and will be removed in April 2025.
Please use generate-standalone-virtual-dashboard.py instead, which has all the same
features with better performance and virtual scrolling support.
...
warnings.warn(
    "\n⚠️  DEPRECATION: generate-ultimate-dashboard.py is deprecated.\n"
...
<body>
    ...
    <script>
        ...
        print(f"✅ Ultimate dashboard generated: {output_file}")
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        print("Usage: generate-ultimate-dashboard.py <analysis.json> [output.html]")
        sys.exit(1)
        
    input_file = sys.argv[1]
    output_file = sys.argv[2] if len(sys.argv) > 2 else 'ultimate-dashboard.html'
