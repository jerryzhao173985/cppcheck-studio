...
exports.VirtualDashboardGenerator = void 0;
const fs = __importStar(require("fs"));
const crypto = __importStar(require("crypto"));
class VirtualDashboardGenerator {
    constructor(issuesFile, options = {}) {
        this.issues = [];
    ...
    generateHTML(stats, issuesJsonl, codeJsonl, withContext) {
        return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
exports.VirtualDashboardGenerator = VirtualDashboardGenerator;
